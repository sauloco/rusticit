...
- Built complex workflows for Canaray Voxel, a dental imaging app: drag-and-drop tree views, anatomy organization, case navigation, and collaboration tools.
- Designed Render Tests, an internal regression-detection workflow using GitLab, Slack, and Trello to catch visual side effects.
...
- Led engineering and long-term maintenance of public-health systems used by 1,000+ internal users across healthcare and administrative areas.
- Consolidated 900,000+ fragmented patient records into 300,000+ unified records (~67% reduction) with zero known false positives.
- Contributed improvements that supported ISO 9001 quality standards for patient admission and identification.
...
Spanish (Native) · English (Fluent) · Argentine Sign Language (Fluent) · German (Basic)
