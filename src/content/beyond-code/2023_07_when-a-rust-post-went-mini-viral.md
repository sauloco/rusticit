---
title: 'When a Rust post went mini-viral'
description: 'A simple LinkedIn post about learning Rust unexpectedly reached far beyond my usual audience and became a small but meaningful signal in my journey into the Rust ecosystem.'
pubDate: 'Jul 25 2023'
tags: ['social media', 'Rust']
heroImage: 'https://images.pexels.com/photos/1763075/pexels-photo-1763075.jpeg'
---
...
It was not even a particularly elaborate piece of content.
...
A person honestly going deeper into a tool.
A developer sharing a real transition.
A public trace of curiosity becoming direction.
...
Later, that path would connect with real work:
open source contributions, collaboration with teams that value Rust deeply, and practical use in frontend-oriented projects through tools like Leptos.

Seen from that perspective, the post was small.
But it was also a marker.
...
And a learning moment can become part of your long-term positioning without you forcing it.
