---
title: 'rusti.codes: turning Rust learning into a product'
tags: ['founder', 'Rust']
description: 'rusti.codes started from a simple idea: use daily Rust coding challenges to help developers sharpen their problem-solving skills and prepare for technical interviews in a more consistent way.'
pubDate: 'Jan 20 2024'
heroImage: 'https://images.unsplash.com/photo-1514994444123-10094655bdb5?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
---
...
That is the spirit behind [**rusti.codes**](https://rusti.codes/).
...
And it helps build a deeper mental model of how software actually works.
...
A lot of people do not fail interview prep because they are incapable.
They fail because practice stays irregular, abstract, or disconnected from a concrete routine.
...
It also reflects something that has become a recurring pattern in my work:
taking something that is personally meaningful and turning it into a more usable experience for other people.
