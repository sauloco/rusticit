...
keyInsights:
  - number: "1120"
    description: "**Languages** the platform serves across Windows, iOS, Android, and web — making carelessness in any component a real failure for a real user."
  - number: "14"
    description: "**Years** of platform history being rewritten from scratch into a single, unified modern frontend."
  - number: "4"
    description: "Separate platform codebases — **Web, Windows, iOS, Android** — consolidated into one project with shared components."
---
